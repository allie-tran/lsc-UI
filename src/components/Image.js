...
const Image = forwardRef(({ image, scale, info, onClick, openEvent, zoomed, disableLazyLoad, highlight, dark, scene}, ref) => {
    ...
    return (
        ...
        >
            ...
            >
                <img
                    alt={image}
                    src={configData.IMAGEHOST_URL + image.split(".")[0] + ".jpg"}
